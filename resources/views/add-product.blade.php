...
<div class="centered-container">
    <div class="container mt-5" id="j">
        @if(session('success'))
            <script>
                Swal.fire({
                    ...
                    customClass: {
                        popup: 'custom-popup', // تصغير حجم النافذة
                        title: 'custom-title', // تصغير حجم العنوان
                        htmlContainer: 'custom-text', // تصغير حجم النص
                        confirmButton: 'custom-button' // تصغير حجم الزر
                    }
                });
            </script>
        @endif
        ...
        <form action="{{ route('add-product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3 d-flex align-items-center gap-3">
                <div>
                    <label for="image" class="form-label" id="image_label">Product Image</label>
                    <input type="file" class="form-control custom-input" id="image" name="image" required>
                </div>
                <div>
                    <label for="Ad-image" class="form-label" id="Ad-image_label">Ad Image (Optional)</label>
                    <input type="file" class="form-control custom-input" id="AdImage" name="AdImage">
                </div>
            </div>
